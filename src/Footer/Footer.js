...
import img from '../Header/education.png'

const Footer = () => {
    return (
        <div>
            <footer className="footer h-50 p-10 bg-neutral lg:flex lg:justify-around lg:items-end text-white text-neutral-content">
                <div>
                    <img src={img} className='w-24' alt="" />
                    <b>Education Beyond Border<br />Providing reliable services since 2018</b>
                </div>
                <div>
                ...
                <p className='lg:p-11 lg:mt-11 text-center'>Copyright © 2022 Education Beyond Border</p>
